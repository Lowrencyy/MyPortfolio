...
const HeroContent = () => {
  return (
    ...
    initial="hidden"
    animate="visible"
    className='flex flex-row item-cneter justify-center px-20 mt-40 w-full z-[20]'
    >
        ...
        >
            ...
            <h1 className='Welcome-text text-[13px]'>Mark Laurence Laurio Tomenio</h1>
        </motion.div>
        ...
        >
            <a href="https://drive.google.com/file/d/1arITHDD2JZVc0YGa2WN0aLFnjswvsN_T/view?usp=sharing" target='_blank' download>Download My Resume</a>
        </motion.a>
        </div>
